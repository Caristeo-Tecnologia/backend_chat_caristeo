...
exports.abstract = exports.remove = exports.update = exports.showFromUUID = exports.show = exports.kanban = exports.store = exports.index = void 0;
...
const TicketAbstractService_1 = __importDefault(require("../services/TicketServices/TicketAbstractService"));
...
const abstract = async (req, res) => {
    const { ticketId } = req.params;
    const data = await (0, TicketAbstractService_1.default)(ticketId);
