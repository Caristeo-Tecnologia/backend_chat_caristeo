...
exports.indexPlan = exports.listPlan = exports.remove = exports.updatePlan = exports.updateSchedules = exports.update = exports.list = exports.show = exports.store = exports.index = void 0;
...
const UpdatePlanCompanyService_1 = __importDefault(require("../services/CompanyService/UpdatePlanCompanyService"));
...
const updatePlan = async (req, res) => {
    ...
    const { id } = req.params;
    const company = await (0, UpdatePlanCompanyService_1.default)({
        id,
        planId
    });
    return res.status(200).json(company);
